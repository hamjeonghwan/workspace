...
public class T15_TableViewTest extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		ObservableList<Member> data = FXCollections.observableArrayList(
				new Member("홍길동", "gildong", 22, "2222-2222", "대전"), new Member("홍길서", "gilseo", 32, "3333-3333", "서울"),
				new Member("홍길남", "gilnam", 42, "4444-4444", "부산"),
		...
		btnEdit.setOnAction(e -> {
			...
			data.set(table.getSelectionModel().getSelectedIndex(), new Member(txtKorName.getText(),
					txtEngName.getText(), Integer.parseInt(txtAge.getText()), txtTel.getText(), txtAddr.getText()));
		...
		btnTest1.setOnAction(e -> {
			...
			// => setEditable(), 이 메서드에 true를 설정하면 '입력 가능' false를 설정하면 '읽기전용'이 된다.
