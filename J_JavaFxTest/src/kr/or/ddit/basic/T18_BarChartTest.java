...
public class T18_BarChartTest extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		ser1.getData().add(new XYChart.Data<String, Number>("한국", 50300));
		...
		ser3.getData().add(new XYChart.Data<>("한국", 120000));
		
		bc.getData().addAll(ser1, ser2, ser3);
		
		Scene scene = new Scene(bc, 800, 600);
		primaryStage.setScene(scene);
		primaryStage.setTitle("BarChartTest");
		primaryStage.show();
