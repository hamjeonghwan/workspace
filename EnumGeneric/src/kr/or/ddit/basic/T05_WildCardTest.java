...
public class T05_WildCardTest {
	public static void main(String[] args) {
		...
		//System.out.println(Juicer.makeJuice(fruitBox));
		 System.out.println(Juicer.makeJuice(appleBox)); // 와일드카드를 이용한 지네릭타입의 확장으로 에러
		// 해결가능
...
class Juicer {
	//static Juice makeJuice(FruitBox<Fruit> box) {
		...
		// static <T extends Fruit> Juice makeJuice(FruitBox<T> box, FruitBox<T> box2) {
		// // 지네릭 메서드 이용(파입파라미터 이용)
