...
public class T02_EnumTest {
	// City 열겨형 객체 선언(기본값을 이용하는 열겨형)
	public enum City {서울, 부산, 대구, 광주, 대전};
	
	// 데이터값을 임의로 지정한 열거형 객체 선언 
	// 데어터값을 정해 줄 경우에는 생성자를 만들어서 괄호속의 값이 변수에 저장되도록 해야 한
	public enum Season{
	...
	public static void main(String[] args) {
		...
		System.out.println("myCity1의 order : " + myCity1.ordinal());
		System.out.println();
		
		System.out.println("myCity2 : " +myCity2.name());
		System.out.println("myCity2의 order : " + myCity2.ordinal());
		System.out.println();
		System.out.println("=========================================");
