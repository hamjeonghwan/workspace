...
public class T14_ObjectStreamTest {
	public static void main(String[] args) {
		// Member 인스턴스 생성
		Member mem1 = new Member("홍길동", 180, "고려");
		Member mem2 = new Member("일지매", 200, "조선");
		Member mem3 = new Member("전성희", 130, "평양");
		Member mem4 = new Member("이순신", 360, "조선");
