...
//		prodTestControl control = new prodTestControl();
	...
	combolprod.valueProperty().addListener(new  ChangeListener<String>() {

			@Override
			public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
				List<String> prod=prodDao.getAll(newValue);
				ObservableList<String> prodName=FXCollections.observableArrayList(prod);
				comboprod.setItems(prodName);
				
			}
		});
	    comboprod.valueProperty().addListener(new ChangeListener<String>() {

			@Override
			public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
				List<ProdVO> allProd=prod
