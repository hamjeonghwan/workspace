...
import kr.or.ddit.main.BoardInfoMng;
...
public class BoardInfoMng {
	...
	private static Logger logger = Logger.getLogger(BoardInfoMng.class);
	
	public void displayMenu() {
		
		logger.info("안녕하세요. Log4j INFO 레벨 메시지입니다.");
		
		logger.debug("안녕하세요. Log4j DEBUG 레벨 메시지입니다.");
	...
	private void searchBoard() {
		...
		for(BoardVO tembv : boardList) {
			
			System.out.println(tembv.getBoard_no() + "     " + tembv.getBoard_title() + "    " + tembv.getBoard_writer() + 
					"     " + tembv.getBoard_date()+ "      ");
			System.out.println("-----------------------------");
		}
	...
	private void insertBoard() {
		int cnt = 0; 
			...
			cnt = boardService.insertBoard(bv);
